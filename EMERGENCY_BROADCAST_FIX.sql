-- EMERGENCY FIX: MISSING AUTO-BROADCAST TRIGGER
-- This will fix the issue where only rafaelpineda471 can see requests
-- The problem: auto-broadcast trigger is not working

-- =====================================================
-- STEP 1: DEPLOY THE COMPLETE BROADCAST SYSTEM
-- =====================================================

-- First, run the complete broadcast system fix
-- (Copy the entire content of COMPLETE_BROADCAST_SYSTEM_FIX_v2.sql here)
...
-- =====================================================
-- STEP 2: CREATE CORE BROADCAST FUNCTIONS
-- =====================================================
...
-- Add routing_type and distance_km columns to request_routing if they don't exist
DO $$
BEGIN
...
-- =====================================================
-- STEP 4: CREATE THE MISSING AUTO-BROADCAST TRIGGER
-- =====================================================
...
-- =====================================================
-- STEP 5: MANUALLY BROADCAST THE EXISTING REQUEST
-- =====================================================

-- Now manually broadcast the existing request that didn't get broadcasted
DO $$
DECLARE
    v_broadcast_result jsonb;
BEGIN
    RAISE NOTICE 'Manually broadcasting existing request: 272fc4e1-2098-4959-8757-8fcb696d8865';
    
    -- Manually trigger broadcast for the existing request
    SELECT broadcast_service_request(
        '272fc4e1-2098-4959-8757-8fcb696d8865',
        14.91271680,
        120.83855360,
        10.0,
        'lockout_service',
...
DO $$
BEGIN
    RAISE NOTICE '🚀 EMERGENCY BROADCAST FIX DEPLOYED!';
    RAISE NOTICE '';
    RAISE NOTICE 'FIXED ISSUES:';
    RAISE NOTICE '✅ Added missing auto-broadcast trigger';
    RAISE NOTICE '✅ Manually broadcasted existing request 272fc4e1-2098-4959-8757-8fcb696d8865';
    RAISE NOTICE '✅ All future requests with shop_id = null will auto-broadcast';
    RAISE NOTICE '';
    RAISE NOTICE 'ALL NEARBY MECHANICS SHOULD NOW SEE THE REQUEST!';
    RAISE NOTICE '';
    RAISE NOTICE 'The request will appear as "New Service Request!" popup';
    RAISE NOTICE 'in all mechanics within 10km of location 14.91271680, 120.83855360';
END $$;