...
-- Test with Rafael's mechanic ID
SELECT 
    request_id,
    title,
    request_type,
...
-- Expected: Should now see the shop-based request!
...
-- =====================================================
-- AFTER RUNNING THIS:
-- 1. Refresh mechanic app (navigate away and back)
-- 2. Request should appear in Nearby Requests!
-- 3. Popup should also work now!
-- =====================================================
