...
Write-Host "   - Look for success message: 'Audit logging system created successfully!'" -ForegroundColor Gray
Write-Host ""
...
Read-Host "Press Enter after you've deployed the SQL script..."
