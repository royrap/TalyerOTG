-- ========================================
-- 🔍 DIAGNOSE VEHICLE INFO ISSUE
-- ========================================
-- Run this script to identify why vehicle info is not showing

\echo '========================================';
\echo '🔍 VEHICLE INFO DIAGNOSTIC REPORT';
\echo '========================================';
\echo '';
...
-- ========================================
\echo '1️⃣ Checking if RPC function has vehicle fields...';
\echo '';
...
-- ========================================
\echo '2️⃣ Testing RPC function output (first 3 records)...';
\echo '';
...
-- ========================================
\echo '3️⃣ Checking service_requests table for vehicle_id...';
\echo '';
...
\echo 'Sample requests WITHOUT vehicles:';
SELECT 
    sr.id,
    sr.title,
    sr.customer_id,
...
-- ========================================
\echo '4️⃣ Checking mechanic_job_history records...';
\echo '';
...
-- ========================================
\echo '5️⃣ Checking vehicles table and RLS policies...';
\echo '';
...
\echo '';
\echo 'RLS Policies on vehicles table:';
SELECT 
    policyname,
    cmd,
    qual
...
-- ========================================
\echo '6️⃣ Sample data check (JOIN test)...';
\echo '';

\echo 'Sample: mechanic_job_history → service_requests → vehicles';
SELECT 
    mjh.job_title,
